...
namespace Mathance.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                var user = new MathanceUser { UserName = Input.Name, Social = info.LoginProvider, Email = Input.Email, RegDate = DateTime.UtcNow.AddHours(3) };
